        ...
        <nav className="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
                ...
                <div className="collapse navbar-collapse" id="navbarCollapse">
                    <div className="navbar-nav mx-auto p-4 p-lg-0">
                        <Link className="m-3" to="/admin">HOME</Link>
                        <Link className="m-3" to="/admin/viewmechanics">MECHANICS</Link>
                        ...
                        <Link className="m-3" to="">TYPE</Link>
                        ...
                        <Link className="m-3" to="/admin/viewbooking">BOOKING</Link>
                        <Link className="m-3" to="/admin/view_contact">CONTACT</Link>
                        <Link className="m-3" to="/admin/feedback">FEEDBACK</Link>
